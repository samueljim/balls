...
Deterministic Balls-like game engine in Rust, compiled to WebAssembly.
...
- `init_round(seed, terrainId, ballPositions)` – start round (ballPositions: [x1,y1, x2,y2, ...] in pixels)
